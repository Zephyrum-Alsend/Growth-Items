...
Lazarus89 - Somewhat Realistic Swords
billryo - Serenity
...
Once initialized, the script lag will be reduced to 0.1 seconds during gameplay
...
1 of 6 options:  Fire, Ice, Volt, Knight-Slayer, Mage-Slayer and Weaken.  Each has their
...
each sub-type appearing.  It will never choose the form that is already active.
...
The specific stat adjustments can be found and changed in the .ini.